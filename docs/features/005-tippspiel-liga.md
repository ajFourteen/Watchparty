...
| 8 | Betrieb | Sicherung der Datenbank, Überwachung des Feeds, Datenschutzerklärung, Secrets | M | offen — Sicherung und Feed-Überwachung als Runbook/Konzept vorbereitet (`docs/betrieb-tippspiel.md`, 2026-08-18), Einrichtung selbst noch nicht gemacht; Datenschutzerklärung und Secrets weiterhin offen |
