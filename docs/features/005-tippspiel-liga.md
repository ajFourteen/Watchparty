...
| 8 | Betrieb | Sicherung der Datenbank, Überwachung des Feeds, Datenschutzerklärung, Secrets | M | offen — Sicherung und Feed-Überwachung als Runbook/Konzept vorbereitet (`docs/betrieb-tippspiel.md`, 2026-08-18); Datenschutzerklärung (`docs/datenschutzerklaerung.md`) und Impressum (`docs/impressum.md`, Angaben von fourteen-it.de) als Entwürfe vorbereitet (2026-08-18) — Auftragsverarbeitungsverträge, Drittlandtransfer bei Fly.io und rechtliche Prüfung offen, beides noch nicht in die Anwendung eingebunden; Secrets weiterhin offen |
