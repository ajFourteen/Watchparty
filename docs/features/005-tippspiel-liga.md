...
| 8 | Betrieb | Sicherung der Datenbank, Überwachung des Feeds, Datenschutzerklärung, Secrets | M | offen — Sicherung und Feed-Überwachung als Runbook/Konzept vorbereitet (`docs/betrieb-tippspiel.md`, 2026-08-18); Datenschutzerklärung als Entwurf vorbereitet (`docs/datenschutzerklaerung.md`, 2026-08-18) — Anschrift, Auftragsverarbeitungsverträge und rechtliche Prüfung offen, noch nicht in die Anwendung eingebunden; Impressum und Secrets weiterhin offen |
