package de.fourteen.watchparty.ws;
 ...
 *
 * Umsetzung von ADR-012: Der Raum-Thread ruft nur {@link #send(String)} auf und
 * legt die Nachricht in die Queue. Das eigentliche Schreiben auf den Socket
 * passiert auf einem Sende-Pool. Damit kann ein langsames oder eingeschlafenes
 * Handy den Eventloop nicht mehr stallen.
 *
...
public class ClientSession {
    ...
    /** Wird ausschliesslich vom Raum-Thread gesetzt und gelesen. */
